<?php 
	...
	if($_POST['hs_login_membership_hidden'] == 'Y') 
	{
		...
		$hs_login_membership_google_form = $_POST['hs_login_membership_google_form'];
		update_option('hs_login_membership_google_form', $hs_login_membership_google_form);
...
<form name="hs_login_membership_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<p><?php _e("HealthSPORT Membership Google Form URL: " ); ?><input type="text" name="hs_login_membership_google_form" value="<?php echo $hs_login_membership_google_form; ?>" size="64"></p>
